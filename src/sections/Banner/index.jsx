        ...
        <section className="py-10 lg:py-20 px-4">
            <div className="relative max-w-7xl mx-auto flex justify-between">
                ...
                <div className="w-full lg:w-[50%] flex flex-col gap-3 items-start">
                    ...
                    <div className="">
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-10">
                            <div className="flex flex-col rouneded-[8px] gap-2 w-full items-center cursor-pointer group bg-white/10 backdrop-blur-sm border border-white/10 rounded-2xl p-4 text-center hover:bg-white/10 transition-all duration-300 hover:scale-105">
                ...
                <div className="lg:w-[40%] hidden lg:flex items-center justify-end w-full">
                    <img src="/icons/casino-3d.webp" alt="3d image" className="w-[400px]"/>
                </div>
            </div>
        </section>
