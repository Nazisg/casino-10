...
export default function Footer() {
  return (
      ...
      <div className="max-w-7xl mx-auto flex flex-col gap-2 lg:gap-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
          ...
          <div className="col-span-1">
            ...
            <div className="space-y-2">
              <a href="#" className="block text-gray-400 hover:text-[#DDA435] transition-colors text-sm">BeGambleAware.org</a>
              <a href="#" className="block text-gray-400 hover:text-[#DDA435] transition-colors text-sm">GamCare.org.uk</a>
              <a href="#" className="block text-gray-400 hover:text-[#DDA435] transition-colors text-sm">GamblingTherapy.org</a>
              <a href="#" className="block text-gray-400 hover:text-[#DDA435] transition-colors text-sm">GamStop.co.uk</a>
            </div>
          </div>
        </div>
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6 mb-3">
        ...
        <div className="border-t border-[#DDA435] mt-2"></div>

        <div className="flex flex-col gap-4 justify-center items-center ">
          <h2 className="text-[#dda435] font-semibold">Gambling Awareness & Support</h2>
          <div className="flex flex-wrap justify-center items-center gap-8">
            <a href="#" className="opacity-70 hover:opacity-100 transition-opacity h-[40px] w-[120px] flex items-center"> <img src="/icons/footer-logo-1.webp" className="object-contain" alt="footer-logo" /></a>
            <a href="#" className="opacity-70 hover:opacity-100 transition-opacity h-[40px] w-[120px] flex items-center" > <img src="/icons/footer-logo-2.webp" className="object-contain" alt="footer-logo" /></a>
            <a href="#" className="opacity-70 hover:opacity-100 transition-opacity h-[40px] w-[120px] flex items-center"> <img src="https://www.top10royalcasino.co.uk/grd.svg" className="object-contain" alt="footer-logo" /></a>
            <a href="#" className="opacity-70 hover:opacity-100 transition-opacity h-[40px] w-[120px] flex items-center"> <img src="/icons/footer-logo-4.svg" className="object-contain" alt="footer-logo" /></a>
            <a href="#" className="opacity-70 hover:opacity-100 transition-opacity h-[40px] w-[120px] flex items-center"> <img src="/icons/footer-logo-5.webp" className="object-contain" alt="footer-logo" /></a>
          </div>
        </div>

        <div className="border-t border-[#dda435] mt-2"></div>

        <div className="bg-red-900/20 border border-[#dda435] rounded-lg p-4 mb-3 mt-3">
          <div className="text-center text-[14px]">
            <h4 className="text-white font-bold text-lg mb-3"> IMPORTANT DISCLAIMER </h4>
            <div className="text-gray-300 text-sm space-y-2 leading-relaxed">
              ...
              <p><strong className="text-[#fff] mt-3">If gambling is becoming a problem, seek help immediately.</strong></p>
            </div>
          </div>
        </div>

        {/* Bottom Section: Copyright */}
                <div className="border-t border-[#DDA435]"></div>

        <div className="text-center">
          <p className="text-[#dda435] text-sm">© 2025 Casino. All rights reserved. This website is for informational purposes only.</p>
